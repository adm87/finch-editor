...
func (t *TilemapEditorSystem) place_tile(world *ecs.World, editorComp *TilemapEditorComponent, tilemap *tm.Tilemap, tileset *ts.Tileset, tilemapID string, newTile int) {
	...
	currentTile := tilemap.GetTile(tx, ty)
